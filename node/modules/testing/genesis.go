...
func MakeGenesisMem(out io.Writer, template genesis.Template) func(bs dtypes.CachedChainBlockstore, syscalls vm.SyscallBuilder, j journal.Journal) modules.Genesis {
	return func(bs dtypes.CachedChainBlockstore, syscalls vm.SyscallBuilder, j journal.Journal) modules.Genesis {
...
func MakeGenesis(outFile, genesisTemplate string) func(bs dtypes.CachedChainBlockstore, syscalls vm.SyscallBuilder, j journal.Journal) modules.Genesis {
	return func(bs dtypes.CachedChainBlockstore, syscalls vm.SyscallBuilder, j journal.Journal) modules.Genesis {
		return func() (*types.BlockHeader, error) {
			glog.Warn("Generating new random genesis block, note that this SHOULD NOT happen unless you are setting up new network")
